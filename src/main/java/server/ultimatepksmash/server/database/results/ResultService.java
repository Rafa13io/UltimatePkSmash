...
public class ResultService {
    ...
    public List<Result1vs1> getUserResults1vs1(Long userId) throws SQLException {
        String sql = "SELECT * FROM p_result_1vs1 WHERE ? IN (winner_id, loser_id);";
        PreparedStatement getResults1vs1 = connection.prepareStatement(sql);
        getResults1vs1.setLong(1, userId);
        ResultSet resultSet = getResults1vs1.executeQuery();
    ...
    public List<Result2vs2> getUserResults2vs2(Long userId) throws SQLException {
        String sql = "SELECT * FROM p_result_2vs2 WHERE ? IN (winner1_id, loser1_id, winner2_id, loser2_id);";
        PreparedStatement getResults1vs1 = connection.prepareStatement(sql);
        getResults1vs1.setLong(1, userId);
        ResultSet resultSet = getResults1vs1.executeQuery();
